...
function Profile() {
  ...
  >
    ...
    <span className="sr-only">Pogledajte obavijesti</span>
  ...
  <Menu as="div" className="relative ml-3">
    <div>
      <Menu.Button className="relative flex text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
        <span className="absolute -inset-1.5" />
        <span className="sr-only">Otvori korisnički izbornik</span>
...
export function NavBar() {
  const navigation = [
    { name: 'Nadzorna ploča', href: '/home', current: false, log : false },
    { name: 'Karta', href: '/map', current: false, log : false },
    { name: 'Statistika', href: '/stats', current: false, log : true },
    { name: 'Novčanik', href: '/wallet', current: false, log : true }
  ];
